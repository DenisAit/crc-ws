          ...
          <div className="p-8 md:p-12">
            ...
            <div className="flex flex-col items-center mb-10">
              <div className="relative mb-6">
                ...
                <div className="absolute inset-0 scale-150">
                  <div className="absolute inset-0 bg-gradient-to-br from-amber-500/30 to-red-500/20 rounded-full blur-2xl animate-pulse" />
                </div>
                <div className="absolute -inset-4 border-2 border-amber-500/20 rounded-full animate-[spin_20s_linear_infinite]" />
                <div className="absolute -inset-8 border border-amber-500/10 rounded-full animate-[spin_30s_linear_infinite_reverse]" />
              ...
              <div className="flex items-center gap-2 mt-3">
                ...
                <span className="text-amber-500/70 text-sm font-medium tracking-widest uppercase">
                  Familia Management
                </span>
                <Sparkles className="h-4 w-4 text-amber-500/70" />
            ...
            <div className="mt-6 pt-4 border-t border-gray-800/30">
              <div className="flex gap-2">
                ...
                >
                  {/* Button Background */}
                  <div className={`absolute inset-0 bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 transition-opacity duration-300 ${isPartnerHovering ? 'opacity-100' : 'opacity-80'}`} />
                  ...
                  {/* Button Content */}
                  <div className="relative flex items-center justify-center gap-2 py-3 px-3 text-gray-200 font-medium text-sm">
                ...
                >
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-r from-yellow-600 via-yellow-500 to-yellow-600 transition-opacity duration-300 ${isTaxiHovering ? 'opacity-100' : 'opacity-80'}`} />
                  ...
                  {/* Button Content */}
                  <div className="relative flex items-center justify-center gap-2 py-3 px-3 text-gray-900 font-semibold text-sm">
                    <Car className={`w-4 h-4 transition-transform duration-300 ${isTaxiHovering ? 'scale-110' : ''}`} />
                    <span>Taxi</span>
                  </div>
                  
                  {/* Glow Effect */}
                  <div className={`absolute -inset-1 bg-yellow-500/40 blur-lg transition-opacity duration-300 -z-10 pointer-events-none ${isTaxiHovering ? 'opacity-50' : 'opacity-0'}`} />
                </button>
              </div>
